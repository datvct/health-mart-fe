...
const ProductDetail = () => {
  ...
  const description_html = `
    <div class="space-y-4">
      ...
      <p>Việc bổ sung lợi khuẩn và vi chất dinh dưỡng đóng vai trò quan trọng...</p>
      <div class="text-center my-4">
        <img 
          src="https://cdn.nhathuoclongchau.com.vn/unsafe/800x0/https://cms-prod.s3-sgn09.fptcloud.com/oteocare_ls_e4aa808117.jpg" 
          alt="Trẻ nhỏ và tiêu hóa" 
          style="border-radius: 0.5rem; overflow: hidden; display: block; margin: auto;"
        />
      </div>
      <p>Sản phẩm hỗ trợ cải thiện hệ tiêu hóa và tăng hấp thu cho trẻ.</p>
    </div>
  `;
  ...
  const ingredients = `
    <div style="overflow-x: auto; width: 100%;">
      ...
      ">
        <thead>
          <tr style="background-color: #cfd4dc;">
            <th style="text-align: left; padding: 0.5em; border: 1px solid white; white-space: nowrap;">
              Thông tin thành phần
            </th>
            <th style="text-align: right; padding: 0.5em; border: 1px solid white; white-space: nowrap;">
              Hàm lượng
            </th>
          </tr>
        </thead>
        <tbody>
          <tr style="background-color: #f1f4f7;">
            <td style="padding: 0.5em; border: 1px solid white;">Omega 3</td>
            <td style="padding: 0.5em; text-align: right; border: 1px solid white;">319mg</td>
          </tr>
          <tr style="background-color: #f1f4f7;">
            <td style="padding: 0.5em; border: 1px solid white;">Calci glucoheptonat</td>
            <td style="padding: 0.5em; text-align: right; border: 1px solid white;">550mg</td>
          </tr>
          <tr style="background-color: #f1f4f7;">
            <td style="padding: 0.5em; border: 1px solid white;">Vitamin D3</td>
            <td style="padding: 0.5em; text-align: right; border: 1px solid white;">100iu</td>
          </tr>
          <tr style="background-color: #f1f4f7;">
            <td style="padding: 0.5em; border: 1px solid white;">Vitamin K2</td>
            <td style="padding: 0.5em; text-align: right; border: 1px solid white;">10mcg</td>
          </tr>
          <tr style="background-color: #f1f4f7;">
            <td style="padding: 0.5em; border: 1px solid white;">Bacillus clausii</td>
            <td style="padding: 0.5em; text-align: right; border: 1px solid white;">—</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  const uses = `
    Hỗ trợ cải thiện hệ tiêu hóa, tăng hấp thu dưỡng chất và giúp trẻ ăn ngon miệng hơn.
  `;

  const usage = `
    Uống trực tiếp. Cho trẻ 0 - 12 tuổi: 1 - 2 ống mỗi ngày. Nên uống vào buổi sáng hoặc trưa. Lắc đều trước khi sử dụng.
  `;
  ...
  const precautions = `
    <div style="background-color: #fff7e6; border-left: 4px solid #ffa940; padding: 1rem; border-radius: 8px;">
      <p style="font-weight: bold; color: #d48806; margin-bottom: 0.5rem;">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 1.5rem; height: 1.5rem; display: inline-block; vertical-align: middle; margin-right: 0.5rem;">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z" />
        </svg>
        Lưu ý
      </p>
      <ul style="margin: 0; padding-left: 1.5rem; color: #595959;">
  ...
  const allTabs = [
    { key: 'description', title: 'Mô tả sản phẩm', content: description_html, isHtml: true },
    { key: 'ingredients', title: 'Thành phần', content: ingredients, isHtml: true },
    { key: 'uses', title: 'Công dụng', content: uses, isHtml: false },
    { key: 'usage', title: 'Cách dùng', content: usage, isHtml: false },
    { key: 'sideEffects', title: 'Tác dụng phụ', content: sideEffects, isHtml: false },
    { key: 'precautions', title: 'Lưu ý', content: precautions, isHtml: true },
    { key: 'storage', title: 'Bảo quản', content: storage, isHtml: false },
  ];
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-4xl font-bold text-blue-600">
                {productData.price.toLocaleString()}đ/ Hộp
              </p>
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-4">
              ...
              <div className="flex gap-2 flex-wrap">
                {productData.units.map((unit, idx) => (
                  <Button key={idx} className="hover:border-blue-600 hover:text-blue-600">
                    {unit}
                  </Button>
                ))}
              </div>
              ...
              <p className="text-base text-gray-500">{productData.shortDescription}</p>
            </div>
            ...
            >
              ...
              <div className="bg-white p-4 flex items-center gap-3">
                ...
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-semibold">{productData.promotion.validUntil}</span>
                </p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="text-sm mt-1">
                <span className="text-orange-600 font-semibold">⚡ Sản phẩm đang được chú ý</span>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md mt-6 flex flex-col lg:flex-row gap-8">
            ...
            {allTabs.map(({ key, title }) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 hover:bg-gray-100 transition ${
                  selectedTab === key ? 'text-lg font-bold bg-gray-200' : 'text-base text-gray-700'
                }`}
        ...
        <div className="lg:w-3/4 w-full space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 border-b pb-2 gap-3">
            <h1 className="text-2xl font-bold text-gray-900">Tên sản phẩm</h1>
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between p-4 border-t border-b rounded-md gap-10">
            ...
            <div className="flex flex-col justify-center w-full space-y-1">
              {[5, 4, 3, 2, 1].map((star) => {
                const count =
                  overallRatingStats.counts[star as keyof typeof overallRatingStats.counts] || 0;
                  ...
                  <div key={star} className="flex items-center gap-2 text-sm">
                    ...
                    <div className="flex w-[72px]">
                      {Array.from({ length: 5 }, (_, i) => (
                        <span key={i} className={i < star ? 'text-yellow-400' : 'text-gray-400'}>
                          ★
                        </span>
                      ))}
                    </div>
          ...
          <div key={review.id} className="mb-4">
            <div className="flex flex-col sm:flex-row items-start sm:space-x-3">
              ...
              <div className="w-full">
                ...
                <div className="flex items-center text-yellow-400">{'★'.repeat(review.rating)}</div>
